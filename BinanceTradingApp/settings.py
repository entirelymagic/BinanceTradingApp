"""
Django settings for BinanceTradingApp project.
...
from config_file import DJANGO_SECRET_KEY
...
INSTALLED_APPS = [
    ...
    'channels',
    'binance_trading_bot.apps.BinanceTradingBotConfig',
]
...
ROOT_URLCONF = 'BinanceTradingApp.urls'
